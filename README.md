...
### 1.2 计算机视觉算法与应用中文版
  - [章节规划大纲](./机器视觉原理应用/计算机视觉算法与应用中文版/章节规划大纲.md)
  - [第1章 概述](./机器视觉原理应用/计算机视觉算法与应用中文版/第1章_概述.md)
  - [第2章 图像形成](./机器视觉原理应用/计算机视觉算法与应用中文版/第2章_图像形成.md)
  - [第3章 图像处理](./机器视觉原理应用/计算机视觉算法与应用中文版/第3章_图像处理.md)
  - [第4章 特征检测与匹配](./机器视觉原理应用/计算机视觉算法与应用中文版/第4章_特征检测与匹配.md)
  - [第5章 分割](./机器视觉原理应用/计算机视觉算法与应用中文版/第5章_分割.md)
  - [第6章 基于特征的配准](./机器视觉原理应用/计算机视觉算法与应用中文版/第6章_基于特征的配准.md)
  - [第7章 由运动到结构](./机器视觉原理应用/计算机视觉算法与应用中文版/第7章_由运动到结构.md)
  - [第8章 稠密运动估计](./机器视觉原理应用/计算机视觉算法与应用中文版/第8章_稠密运动估计.md)
  - [第9章 图像拼接](./机器视觉原理应用/计算机视觉算法与应用中文版/第9章_图像拼接.md)
  - [第10章 计算摄影学](./机器视觉原理应用/计算机视觉算法与应用中文版/第10章_计算摄影学.md)
  - [第11章 立体视觉对应](./机器视觉原理应用/计算机视觉算法与应用中文版/第11章_立体视觉对应.md)
  - [第12章 3D重建](./机器视觉原理应用/计算机视觉算法与应用中文版/第12章_3D重建.md)
  - [第13章 基于图像的绘制](./机器视觉原理应用/计算机视觉算法与应用中文版/第13章_基于图像的绘制.md)
  - [第14章 识别](./机器视觉原理应用/计算机视觉算法与应用中文版/第14章_识别.md)
  - [第15章 结语](./机器视觉原理应用/计算机视觉算法与应用中文版/第15章_结语.md)
  - [附录A 线性代数与数值方法](./机器视觉原理应用/计算机视觉算法与应用中文版/附录A_线性代数与数值方法.md)
  - [附录B 贝叶斯建模与推断](./机器视觉原理应用/计算机视觉算法与应用中文版/附录B_贝叶斯建模与推断.md)
  - [附录C 补充材料](./机器视觉原理应用/计算机视觉算法与应用中文版/附录C_补充材料.md)
